...
ROW_SELECT = 10;   % MATLAB is 1-indexed (Python's 1 -> MATLAB's 2)
...
%% Cell 9 — Rotation matrices
%  (Original Python used the name `LeftHand` here even though the dict was
%  called `LeftHandQuaternions`. Aliased below for fidelity.)
LeftHand = LeftHandQuaternions;
